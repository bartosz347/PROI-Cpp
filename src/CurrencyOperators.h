...
Currency operator+(Currency c1, const Currency c2) {return c1+=c2;} //todo as reference
inline Currency operator-( Currency c1, const Currency c2) {return c1-=c2;} // todo all should be inline
